...
const double RENEWABLE_ENERGY = 53.0;
const double CO2_SAVE = 2.3;
const double MONEY_SAVE = 0.013;

class CustomDialog extends StatelessWidget {
  final String name, description, buttonText;
  final Image image;
  final Function(String, String) onAgreed;
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                "The best starting time for your " + name + ":",
              ...
              Text("possible money save: " + MONEY_SAVE.toString() + "€"),
              Text("possible CO2 save: " + CO2_SAVE.toString() + "kg"),
              Text("renewable energy: " + RENEWABLE_ENERGY.toString() + "%"),
...
// connection to bosch iot dishwasher
